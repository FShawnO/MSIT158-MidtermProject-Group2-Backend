namespace 後台.付帳
{
    partial class Credit_Card
    {
        ...
        private void InitializeComponent()
        {
            ...
            this.fbUsePoint = new prjComponentDemo.usercontrol.FieldBox();
            this.fbAllPoint = new prjComponentDemo.usercontrol.FieldBox();
            this.fbPoint = new prjComponentDemo.usercontrol.FieldBox();
            this.fbTotalPrice = new prjComponentDemo.usercontrol.FieldBox();
            this.fbName = new prjComponentDemo.usercontrol.FieldBox();
            this.fbExpectedPoint = new prjComponentDemo.usercontrol.FieldBox();
            this.fbDeposit = new prjComponentDemo.usercontrol.FieldBox();
            this.fbState = new prjComponentDemo.usercontrol.FieldBox();
            this.fbStateId = new prjComponentDemo.usercontrol.FieldBox();
            this.SuspendLayout();
            // 
            // label1
            // 
        ...
        private prjComponentDemo.usercontrol.FieldBox fbTotalPrice;
        private prjComponentDemo.usercontrol.FieldBox fbPoint;
        private prjComponentDemo.usercontrol.FieldBox fbAllPoint;
        private prjComponentDemo.usercontrol.FieldBox fbUsePoint;
        private prjComponentDemo.usercontrol.FieldBox fbPrice;
        private prjComponentDemo.usercontrol.FieldBox fbExpectedPoint;
        private prjComponentDemo.usercontrol.FieldBox fbDeposit;
        private prjComponentDemo.usercontrol.FieldBox fbState;
        private prjComponentDemo.usercontrol.FieldBox fbStateId;
    }
}