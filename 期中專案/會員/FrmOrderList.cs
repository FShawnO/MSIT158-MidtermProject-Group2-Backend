...
namespace 後台.會員
{
    public partial class FrmOrderList : Form
    {
        ...
        private void resetGridStyle()
        {
            ...
            dataGridView1.Columns[8].HeaderText = "售出狀態";
        ...
        private void queryAll2()
        {
            ...
            var orders = from r in db.tPurchases
                         ...
                         || r.tOrder.tMember.MemberID.ToString().ToUpper().Contains(txtKeyword.Text.ToUpper())
                         || r.tOrder.tMember.MemberName.ToString().ToUpper().Contains(txtKeyword.Text.ToUpper())
                         ...
                         || r.tOrder.tPackageWayDetails.Select(x=>x.tAllPackage.PackName.ToString().ToUpper()).Contains(txtKeyword.Text.ToUpper())
                         || r.tOrder.tPackageWayDetails.Select(x=>x.tAllPackage.Picture.ToString().ToUpper()).Contains(txtKeyword.Text.ToUpper())
                         || r.tOrder.tPackageWayDetails.Select(x=>x.tAllPackage.packageMaterial.MaterialName.ToString().ToUpper()).Contains(txtKeyword.Text.ToUpper())
                         || r.tOrder.tPackageWayDetails.Select(x=>x.tAllPackage.packageMaterial.MaterialColor.ColorName.ToString().ToUpper()).Contains(txtKeyword.Text.ToUpper())
                         || r.tOrder.tPackageWayDetails.Select(x=>x.tAllPackage.GiftPackageStyle.StyleName.ToString().ToUpper()).Contains(txtKeyword.Text.ToUpper())
                         || r.tOrder.tPackageWayDetails.Select(x=>x.tAllPackage.Price.ToString().ToUpper()).Contains(txtKeyword.Text.ToUpper())
                         orderby r.tOrder.OrderID
                         select new
                         {
                             r.PurchaseID,
