namespace 後台
{
    partial class Frm產品明細
    {
        ...
        private void InitializeComponent()
        {
			...
			this.label1.Text = "編輯";
			this.label1.Click += new System.EventHandler(this.產品編輯_Click);
			// 
			// 產品個別detail
			// 
			...
			this.產品個別detail.Text = "產品detail";
			this.產品個別detail.Click += new System.EventHandler(this.產品個別detail_Click);
			// 
			// 產品刪除
			// 
			...
			this.產品新增.Text = "新增";
			this.產品新增.Click += new System.EventHandler(this.label1_Click);
			// 
			// dataGridView1
			// 
			...
			this.Activated += new System.EventHandler(this.Frm產品明細_Activated);
			this.Load += new System.EventHandler(this.Frm產品明細_Load);
